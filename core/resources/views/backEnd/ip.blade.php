                                ...
                                <table class="table  table-striped b-t">
                                    ...
                                    @foreach($AnalyticsVisitors as $AnalyticsVisitor)
                                        @if($lmt==0)
                                            ...
                                            <tr>
                                                <td class="dker">{{ __('backend.visitorsAnalyticsByAddress') }}:
                                                </td>
                                                <td>{{ $AnalyticsVisitor->full_address }}</td>
                                            </tr>
                                            <tr>
                                                <td class="dker">{{ __('backend.visitorsAnalyticsByHostName') }}:
                                                </td>
                                                <td>{{ $AnalyticsVisitor->hostname }}</td>
                                            </tr>
                                            <tr>
                                                <td class="dker">{{ __('backend.visitorsAnalyticsByOrganization') }}
                                                    :
                                                </td>
