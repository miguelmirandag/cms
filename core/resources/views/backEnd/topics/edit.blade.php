                                                ...
                                                <div class="col-sm-9">
                                                    <div class="radio">
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_0.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_1.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_2.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_3.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_4.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_5.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                        <label class="ui-check ui-check-md">
                                                            ...
                                                            <i class="dark-white"></i>
                                                            <img
                                                                src="{{ URL::to('backEnd/assets/images/marker_6.png')}}"
                                                                style="width: 25px;">
                                                        </label>
                                                    </div>
                                                </div>
                                                        ...
                                                        @foreach($Topics->maps as $map)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <img
                                                                        src="{{ URL::to('backEnd/assets/images/marker_').$map->icon.".png" }}"
                                                                        style="width: 20px;">
                                                                    @if($title !="")
                                                                        <small>{!! $title !!}</small>
                                                                    @else
