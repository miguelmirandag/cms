            ...
            <div class="col-sm-7 col-lg-10 light lt">
                ...
                <div class="tab-content pos-rlt">
                    ...
                    <button type="submit" id="save-settings-btn"
                            class="btn btn-info m-a pull-right">{{ __('backend.update') }}</button>
                                        ...
                                        @foreach($Languages as $Language)
                                            <tr>
                                                <td>
                                                    @if($Language->icon !="")
                                                        <img
                                                            src="{{ asset('backEnd/assets/images/flags/'.$Language->icon.".svg") }}"
                                                            alt="" class="w-20">
                                                    @endif
                                                    &nbsp; {{ $Language->title }}</td>
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'SEOSettingTab') ? 'active' : '' }}"
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <p>
                                {!! __('backend.seoFixUrlsService') !!}<br>
                    ...
                    <div
                        class="tab-pane {{  ( Session::get('active_tab') == 'registrationSettingsTab') ? 'active' : '' }}"
                        id="tab-4">
                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'mailSettingsTab') ? 'active' : '' }}"
                        ...
                        <div class="p-a-md col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::text('mail_driver',$WebmasterSetting->mail_driver, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                            <div class="form-group">
                                <label>{!!  __('backend.mailHost') !!}</label>
                                {!! Form::text('mail_host',$WebmasterSetting->mail_host, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                            <div class="form-group">
                                <label>{!!  __('backend.mailPort') !!}</label>
                                {!! Form::text('mail_port',$WebmasterSetting->mail_port, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                            <div class="form-group">
                                <label>{!!  __('backend.mailUsername') !!}</label>
                                {!! Form::text('mail_username',$WebmasterSetting->mail_username, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                            <div class="form-group">
                                <label>{!!  __('backend.mailPassword') !!}</label>
                                {!! Form::text('mail_password',$WebmasterSetting->mail_password, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                            <div class="form-group">
                                <label>{!!  __('backend.mailEncryption') !!}</label>
                                <select name="mail_encryption" class="form-control c-select">
                                    <option
                                        value="" {{ ($WebmasterSetting->mail_encryption== "") ? "selected='selected'":""  }}>
                                        none
                                    </option>
                                    <option
                                        value="ssl" {{ ($WebmasterSetting->mail_encryption== "ssl") ? "selected='selected'":""  }}>
                                        ssl
                                    </option>
                                    <option
                                        value="tsl" {{ ($WebmasterSetting->mail_encryption== "tsl") ? "selected='selected'":""  }}>
                                        tsl
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                {!! Form::text('mail_no_replay',$WebmasterSetting->mail_no_replay, array('placeholder' => '','class' => 'form-control', 'dir'=>'ltr')) !!}
                            </div>
                                        ...
                                        <select name="icon"
                                            ...
                                            @foreach ($Countries as $country)
                                                ...
                                                <option value="{{ $country->code  }}"
                                                        data-data='{"image": "{{ asset('backEnd/assets/images/flags/'.mb_strtolower($country->code).'.svg') }}","code":"+{{ $country->tel }}","search-text":"{{ $country->{"title_" . __('backend.boxCode')} }}  +{{ $country->tel }}"}'>{{ $title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
