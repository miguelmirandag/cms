                ...
                initDashboardDaterange: function () {
                    ...
                    $('#dashboard-report-range').daterangepicker({
                                ...
                                ranges: {
                                    ...
                                    '{{ __('backend.yesterday') }}': [moment().subtract('days', 1), moment().subtract('days', 1)],
                                    '{{ __('backend.last7Days') }}': [moment().subtract('days', 6), moment()],
                                    '{{ __('backend.last30Days') }}': [moment().subtract('days', 29), moment()],
                                    '{{ __('backend.thisMonth') }}': [moment().startOf('month'), moment().endOf('month')],
                                    '{{ __('backend.lastMonth') }}': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
                                },
                                buttonClasses: ['btn'],
                                applyClass: 'primary',
                                cancelClass: 'default',
