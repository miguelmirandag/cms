...
@section('content')
    <style>
        @media (min-width: 768px) {
            .alert {
                margin-{{ @Helper::currentLanguage()->left }}: 210px !important;
            }
        }
    </style>
        ...
        <div class="padding pos-rlt">
            <div>
                ...
                <a href="{{ route("webmails",["group_id"=>"create"]) }}"
                   class="btn white"> <i class="fa fa-plus"></i>&nbsp; {!! __('backend.compose') !!}</a>
            </div>
            <div class="hidden-xs-down m-t" id="inbox-menu">
                ...
                @if(count($WebmailsGroups)>0)
                    <div class="m-y">{!! __('backend.labels') !!} :</div>
                ...
                <div class="p-y">
                    @if(Session::has('EditWebmailsGroup'))
                        ...
                        <div class="input-group input-group-sm">
                            {!! Form::text('name',Session::get('EditWebmailsGroup')->name, array('placeholder' => __('backend.newGroup'),'class' => 'form-control','id'=>'name','required'=>'')) !!}
