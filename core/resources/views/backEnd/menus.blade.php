                                ...
                                @foreach($Menus as $Menu)
                                    ...
                                    @foreach($Menu->subMenus as $subMenu)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ URL::to('backEnd/assets/images/treepart_'.@Helper::currentLanguage()->direction.'.png') }}" class="submenu_tree">
                        ...
                        <footer class="dker p-a">
                            <div class="row">
                                ...
                                <div class="col-sm-3 text-center">
                                    <small class="text-muted inline m-t-sm m-b-sm">{{ __('backend.showing') }} {{ $Menus->firstItem() }}
