                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @if($Banners->{$file_name.$ActiveLanguage->code}!="")
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-4 box p-a-xs">
                                                            <a target="_blank"
                                                               href="{{ URL::to('uploads/banners/'.$Banners->{$file_name.$ActiveLanguage->code}) }}"><img
                                                                    src="{{ URL::to('uploads/banners/'.$Banners->{$file_name.$ActiveLanguage->code}) }}"
                                            ...
                                            @else
                                                <a target="_blank"
                                                   href="{{ URL::to('uploads/banners/'.$Banners->{$file_name.$ActiveLanguage->code}) }}">{!!  $Banners->{$file_name.$ActiveLanguage->code} !!}</a>
                                            @endif
                                        @endif
