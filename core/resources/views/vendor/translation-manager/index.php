...
<div class="container-fluid">
    <h4>Step 1 : Choose Append new Translation & click Import groups to import all translation files:</h4>
    ...
    <form role="form" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddGroup') ?>">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <div class="form-group">
            <h4>Step 2 : Choose Group/File to update it's translation:</h4>
...
<br>
        <fieldset>
            <legend>Step 3 : Export all translations again to files:</legend>
