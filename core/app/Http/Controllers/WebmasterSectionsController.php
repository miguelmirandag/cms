...
class WebmasterSectionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('WebmasterSectionsController@index')->with('doneMessage', __('backend.addDone'));
    }
    ...
    public function updateAll(Request $request)
    {
        ...
        return redirect()->action('WebmasterSectionsController@index')->with('doneMessage', __('backend.saveDone'));
    }
