...
class WebmailsController extends Controller
{
    ...
    public function storeGroup(Request $request)
    {
        ...
        return redirect()->action('WebmailsController@index')->with('doneMessage',
            __('backend.saveDone'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->btn_clicked != "draft") {
            ...
            return redirect()->action('WebmailsController@index')->with('doneMessage', __('backend.messageSentSuccessfully'));
        }

        return redirect()->action('WebmailsController@index')->with('doneMessage', __('backend.saveDone'));
    }
    ...
    public function updateAll(Request $request)
    {
        ...
        return redirect()->action('WebmailsController@index')->with('doneMessage2', __('backend.saveDone'));
    }
