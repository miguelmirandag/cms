    ...
    public function updateSiteInfo(Request $request)
    {
        ...
        if (!empty($Setting)) {
            ...
            $this->validate($request, [
                'style_logo_en' => 'mimes:png,jpeg,jpg,gif',
                'style_logo_ar' => 'mimes:png,jpeg,jpg,gif',
                'style_fav' => 'mimes:png,jpeg,jpg,gif',
                'style_apple' => 'mimes:png,jpeg,jpg,gif',
                'style_bg_image' => 'mimes:png,jpeg,jpg,gif',
                'style_footer_bg' => 'mimes:png,jpeg,jpg,gif'
            ]);
