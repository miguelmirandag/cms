...
class EventsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('EventsController@index')->with('doneMessage', __('backend.addDone'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($Event)) {
            ...
            $Event->save();
            return redirect()->action('EventsController@index', $id)->with('doneMessage', __('backend.saveDone'));
        } else {
            return redirect()->action('EventsController@index');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty($Event)) {
            $Event->delete();
            return redirect()->action('EventsController@index')->with('doneMessage', __('backend.deleteDone'));
        } else {
            return redirect()->action('EventsController@index');
        }
    }
    ...
    public function updateAll()
    {
        ...
        return redirect()->action('EventsController@index')->with('doneMessage', __('backend.saveDone'));
    }
