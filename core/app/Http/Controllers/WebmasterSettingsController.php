...
class WebmasterSettingsController extends Controller
{
    ...
    public function edit()
    {
        ...
        if (!empty($WebmasterSetting)) {
            return view("backEnd.webmaster.settings", compact("WebmasterSetting", "GeneralWebmasterSections", "ParentMenus", "WebmasterBanners", "ContactsGroups", "SitePages", "PermissionsGroups", "Countries", "Languages"));
