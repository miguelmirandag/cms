...
class BannersController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            if ($ActiveLanguage->box_status) {
                ...
                if ($request->$formFileName != "") {
                    $this->validate($request, [
                        $formFileName => 'mimes:png,jpeg,jpg,gif'
                    ]);
        ...
        return redirect()->action('BannersController@index')->with('doneMessage', __('backend.addDone'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($Banner)) {
            ...
            $Banner->save();
            return redirect()->action('BannersController@edit', $id)->with('doneMessage', __('backend.saveDone'));
        } else {
            return redirect()->action('BannersController@index');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty($Banner)) {
            ...
            $Banner->delete();
            return redirect()->action('BannersController@index')->with('doneMessage', __('backend.deleteDone'));
        } else {
            return redirect()->action('BannersController@index');
        }
    }
    ...
    public function updateAll(Request $request)
    {
        ...
        return redirect()->action('BannersController@index')->with('doneMessage', __('backend.saveDone'));
    }
